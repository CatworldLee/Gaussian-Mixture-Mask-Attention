...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 ...
                 is_GMM=False, is_SLM=False, num_kernals=5, mask=None):
        super().__init__()
        ...
        self.attn = Attention(
            ...
            is_GMM=is_GMM, is_SLM=is_SLM, num_kernals=num_kernals, mask=mask)
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, in_dim = 256, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., num_patches=0, 
        ...
        if is_GMM:
            ...
            self.mask = Simple_Mask(num_heads=self.num_heads, num_patches=num_patches)
        else:
            self.mask = None
    ...
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, embed_dim=256, depth=12,
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, num_patches=num_patches, 
                is_GMM=is_GMM, is_SLM=is_SLM, num_kernals=num_kernals, mask=self.mask)
